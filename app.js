document.addEventListener("DOMContentLoaded", async () => {
  ...
  const web3 = new Web3("http://localhost:7545"); // Promijenite na odgovarajući RPC endpoint

  // Adresa pametnog ugovora i ABI
  const contractAddress = "0xF947168d836698b37AAe4cd782d6e4B24923C439";
  const contractABI = [
    {
      inputs: [
        {
